      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            {/* Redes Sociais Oficiais com Cores Específicas no Hover */}
            <div className="pt-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#101822] border border-[#2a475e] text-[#8f98a0] hover:text-[#0A66C2] hover:border-[#0A66C2] hover:bg-[#0A66C2]/15 hover:shadow-[0_0_12px_rgba(10,102,194,0.4)] transition-all"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Rede social X da DSR"
                  className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#101822] border border-[#2a475e] text-[#8f98a0] hover:text-white hover:border-white hover:bg-white/15 hover:shadow-[0_0_12px_rgba(255,255,255,0.3)] transition-all"
                  title="X (Twitter) da DSR"
                >
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#101822] border border-[#2a475e] text-[#8f98a0] hover:text-[#FF0000] hover:border-[#FF0000] hover:bg-[#FF0000]/15 hover:shadow-[0_0_12px_rgba(255,0,0,0.4)] transition-all"
                ...
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#101822] border border-[#2a475e] text-[#8f98a0] hover:text-[#E4405F] hover:border-[#E4405F] hover:bg-[#E4405F]/15 hover:shadow-[0_0_12px_rgba(228,64,95,0.4)] transition-all"
                ...
                <a
                  ...
                  className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#101822] border border-[#2a475e] text-[#8f98a0] hover:text-[#25D366] hover:border-[#25D366] hover:bg-[#25D366]/15 hover:shadow-[0_0_12px_rgba(37,211,102,0.4)] transition-all"
                  title="WhatsApp (11) 95234-5037"
                >
                  <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href="/produtos/retificador-padrao-industrial-modelo-rit-d" className="hover:text-[#66c0f4] transition-colors">
                  Retificador Industrial Analógico (RIT-D)
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs">
              <li className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-[#66c0f4]" /> Tel / WhatsApp: (11) 95234-5037
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Rua Frei Cristóvão Severim, 169 - Jardim Nossa Senhora do Carmo<br />CEP 08275-240 - São Paulo / SP</span>
              </li>
            </ul>
          </div>
        </div>
